...
model_t* trav_get_model(scene_t* scene,tinygltf::Model* cmodel,object_t* node,int mesh_idx,model_t* model,std::unordered_map<int,object_t*>& nodes);
...
object_t* trav_get_node(scene_t* scene,tinygltf::Model* cmodel,object_t* parent,int node_idx,std::unordered_map<int,object_t*>& nodes);
...
object_t* create_node(scene_t* scene,tinygltf::Node& cnode){
    using namespace tinygltf;
...
object_t* Assets::LoadAnimateModel(const char *filename, scene_t* scene) {
    using namespace tinygltf;
